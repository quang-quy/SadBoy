<template>
  <app-wrapper :showThongTinChungBenhAn="false">
    <div
      ...
      style="background: #f8f9f9; position: relative"
    >
      <div class="menu-top">
        <div
        ...
        >
          ...
          <div class="d-flex">
            ...
            <v-btn color="primary" @click="updateData" small depressed :disabled="!disableActions.export" :loading="isLoading">
...
import { update, printBa } from "@/api/benh-an.js";
...
export default {
  ...
  methods: {
    ...
    getThongTinBenhAn(benhAn, benhAnkdt) {
