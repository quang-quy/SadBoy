  ...
  <div>
    ...
    <el-form>
      <v-row>
        ...
        <v-col cols="12" class="padding-cols">
          <el-form-item label="Quá trình bệnh lý và diễn biến lâm sàng">
            <el-input
              ...
              :rows="2"
              size="small"
              v-model="form.quaTrinhBenhLy"
            ></el-input>
          </el-form-item>
        </v-col>
        <v-col cols="12" class="padding-cols">
          <el-form-item label="Tóm Tắt kết quả cận lâm sàng">
            ...
            <v-row>
              ...
              <v-col cols="12" class="padding-cols">
                <el-form-item label="Bệnh chính">
                  <base-select-async
                    v-model="form2.benhChinh.maBenh"
          ...
          <div style="border: 1px solid #d6dbdf" class="pa-4 pb-8">
            <v-row>
              ...
              <v-col cols="12" class="padding-cols">
                <el-form-item label="Bệnh chính">
                  <base-select-async
                    v-model="form2.maBenhChinhVvyhct"
              ...
              <v-col cols="12" class="padding-cols">
                <el-form-item label="Bệnh kèm theo 1">
                  <base-select-async
                    v-model="form2.maBenhKemVv1yhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenhBhyt}`"
                    keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT"
                    placeholder=""
              ...
              <v-col cols="12" class="padding-cols">
                <el-form-item label="Bệnh kèm theo 2">
                  <base-select-async
                    v-model="form2.maBenhKemVv2yhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenhBhyt}`"
                    keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT"
                    placeholder=""
              ...
              <v-col cols="12" class="padding-cols">
                <el-form-item label="Bệnh kèm theo 3">
                  <base-select-async
                    v-model="form2.maBenhKemVv3yhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenhBhyt}`"
                    keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT"
                    placeholder=""
              ...
              <v-col cols="12" class="padding-cols">
                <el-form-item label="Phương pháp điều trị">
                  <el-input v-model="form.ppdttheoYhct" size="small"></el-input>
                </el-form-item>
              </v-col>
            </v-row>
          </div>
        ...
        <v-col cols="12" class="padding-cols">
          <div style="font-weight: bold; font-size: 14px">Ra viện</div>
        </v-col>
          ...
          <div style="border: 1px solid #d6dbdf" class="pa-4 pb-8">
            <v-row>
              ...
              <v-col cols="12" class="padding-cols">
                <el-form-item label="Bệnh chính">
                  <base-select-async
                    v-model="form2.maBenhChinhRvyhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenhBhyt}`"
                    keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT"
                    placeholder=""
              ...
              <v-col cols="12" class="padding-cols">
                <el-form-item label="Bệnh kèm theo 1">
                  <base-select-async
                    v-model="form2.maBenhKemRv1yhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenhBhyt}`"
                    keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT"
                    placeholder=""
              ...
              <v-col cols="12" class="padding-cols">
                <el-form-item label="Bệnh kèm theo 2">
                  <base-select-async
                    v-model="form2.maBenhKemRv2yhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenhBhyt}`"
                    keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT"
                    placeholder=""
              ...
              <v-col cols="12" class="padding-cols">
                <el-form-item label="Bệnh kèm theo 3">
                  <base-select-async
                    v-model="form2.maBenhKemRv3yhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenhBhyt}`"
                    keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT"
                    placeholder=""
        ...
        <v-col xl="2" lg="2" md="4" cols="3" class="padding-cols">
          <el-form-item label="Số tờ X-Quang">
            <el-input-number
              style="width: 100%"
              size="small"
              controls-position="right"
              v-model="form.soToXquang"
            >
            </el-input-number>
          </el-form-item>
        </v-col>
        ...
        <v-col xl="2" lg="2" md="4" cols="3" class="padding-cols">
          <el-form-item label="Người giao hồ sơ">
            <base-select-async
              v-model="form.nguoiGiaoHs"
              placeholder="Tìm kiếm theo tên"
              :label="(item) => `${item.hoTen} - ${item.maNv} - ${item.khoa.tenKhoa}`"
              keyValue="maNv"
              :apiFunc="getNhanVien"
              style="width: 100%"
              size="small"
