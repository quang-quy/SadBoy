...
export default {
  ...
  data: (vm) => ({
    fields: [
      ...
      //     default: null,
      //     type: "select",
      //     useCategory: "xacNhanLuuTru",
      //     placeholder: "Đã lưu trữ",
      //   },
      // },
      // {
      //   text: "Số lưu trữ",
    ...
    apiCrudFunctions: {
      index: (params) =>
        index({ ...params, xacNhanKetThucHS: 1, xacNhanLuuTru: 0 }),
      destroy,
    },
    ...
    actions: ["detail:/HSBALT/Detail/:idba"],
    disableActions: {
